<template>
  ...
  <div class="left-nav">
    ...
    <!-- 主导航 -->
    <div class="nav">
      <div class="nav-item" :class="{ 'nav-item-active': activeNav === '首页' }" @click="activeNav = '首页'">首页</div>
      <div class="nav-item" :class="{ 'nav-item-active': activeNav === '角色' }" @click="activeNav = '角色'">角色</div>
...
.left-nav {
  ...
  border-right: 0.1rem solid rgba(0, 0, 0, 0.06);
}
